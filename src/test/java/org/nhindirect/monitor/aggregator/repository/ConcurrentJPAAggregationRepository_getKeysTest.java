...
public class ConcurrentJPAAggregationRepository_getKeysTest extends SpringBaseTest 
{
	...
	@Test
	public void testGetKeys_emptyRepository_assertEmptyList() throws Exception
	{
	...
	@Test
	public void testGetKeys_singleEntry_assertSingleKey() throws Exception
	{
		try (final ConcurrentJPAAggregationRepository repo = new ConcurrentJPAAggregationRepository(aggRepo, aggCompRepo, 120))
		{
	...
	@Test
	public void testGetKeys_multipleEntries_assertMultipleKeys() throws Exception
	{
		try (final ConcurrentJPAAggregationRepository repo = new ConcurrentJPAAggregationRepository(aggRepo, aggCompRepo, 120)){
