...
@TestPropertySource(properties = "camel.springboot.routes-include-pattern=classpath:distributedAggregatorRoutes/monitor-route-to-error-message-generator.xml")
